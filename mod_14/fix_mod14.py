#!/usr/bin/env python3
#=========================================================================================================
# fix_mod14.py - Script de fortificación para el módulo 14 - Copias de seguridad
#=========================================================================================================
...
#
# Los errores se registran en /var/log/hardening/modulo14_fix.log
#
...
LOG_FILE= "/var/log/hardening/modulo14_fix.log"
...
def mostrar_menu():
    print()
    print("="*100)
    print("MÓDULO 14: COPIAS DE SEGURIDAD.")
    print("="*100)
    print()
